...
import headerImg from "../assets/img/profile_poto.jpeg";
...
export const Banner = () => {
  ...
  const toRotate = [ "ML Engineer", "Web Developer", "UI/UX Designer" ];
  const period = 1000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Pavan`} </h1> 
                  ...
                  <a href={`${process.env.PUBLIC_URL}/Resume.pdf`} download="PavanResume.pdf">
